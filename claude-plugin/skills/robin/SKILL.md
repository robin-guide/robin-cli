...
- Write, target, and schedule announcements: [`skills/robin-announcement-builder/SKILL.md`](./announcement-builder/SKILL.md)
- Analyze conversations and produce a quality report: [`skills/robin-conversation-assessment/SKILL.md`](./conversation-assessment/SKILL.md)
